...
{
    internal class DAOImatges
    {
        public static void Insert(DatabaseConnection dbConn, Imatges imatge)
        {
            dbConn.Open();

            string sql = @"INSERT INTO Imatge (Id,  nom)
                           VALUES (@Id, @id_user, @nom)";

            using SqlCommand cmd = new SqlCommand(sql, dbConn.sqlConnection);
            cmd.Parameters.AddWithValue("@Id", imatge.Id);
            cmd.Parameters.AddWithValue("@id_user", imatge.Dimensions);
            cmd.Parameters.AddWithValue("@nom", imatge.Alcada);
            cmd.Parameters.AddWithValue("@nom", imatge.Amplada);
